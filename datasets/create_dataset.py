...
if __name__ == '__main__':
    ...
    argparser.add_argument('--folder', type=str, default='../../FFHQ-Aging-Dataset/ffhq_aging256x256',
                           help='Location of the raw FFHQ-Aging dataset')
    argparser.add_argument('--labels_file', type=str, default='../../FFHQ-Aging-Dataset/ffhq_aging_labels.csv',
                           help='Location of the raw FFHQ-Aging dataset')
